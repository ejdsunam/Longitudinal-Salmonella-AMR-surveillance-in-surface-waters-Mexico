...
sink()
print("Raw console summary successfully exported as 'Raw_Output_Table_2A_GLMM_Prevalence.txt'!")
# ------------------------------------------------------------------------------------------------------------------------
...
print("EXPORTING RAW GLMM CONSOLE SUMMARY FOR REPOSITORIES")
sink("Raw_Output_Table_2C_GLMM_MDRf.txt")
...
sink()
print("Raw console summary successfully exported as 'Raw_Output_Table_2C_GLMM_MDRf.txt'!")
